...
function $a(e) {
  ...
  n !== null && ((e.alternate = null), $a(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Fe], delete n[Vt], delete n[go], delete n[Kf], delete n[Yf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
const Ld = ({ id: e, name: n, array: t, element: r, setArray: l }) =>
    we.jsxs(
      "div",
      {
        ...
        id: e,
        children: [
          we.jsx("li", { className: "li inline", children: n }, Math.random()),
          we.jsx(
            "button",
            {
              ...
              onClick: () => {
                console.log(r);
                let o = t.filter((u) => u !== r);
                l(o),
                  (o = JSON.stringify(o)),
                  localStorage.setItem("Array", o),
                  console.log(t);
              },
              children: "Delete",
            },
  ...
  Td = () => {
    let e = 1;
    const [n, t] = kt.useState(),
      [r, l] = kt.useState([]);
    kt.useEffect(() => {
      let u = localStorage.getItem("Array");
      u == null ? l([]) : ((u = JSON.parse(u)), l(u)), console.log(u);
    }, []);
    const o = (u) => {
      let i = { name: n, id: e++ };
      u.preventDefault(),
        l(() => {
          let s = [...r, i],
            c = JSON.stringify(s);
          return localStorage.setItem("Array", c), s;
        });
    };
    return we.jsxs("div", {
      className: "container center",
      children: [
        we.jsx("h1", { className: "h1", children: "Todo App" }),
        we.jsxs("form", {
        ...
        we.jsx("ol", {
          ...
          children: r.map((u) => {
            ...
            return we.jsx(
              Ld,
              { name: i, id: s, array: r, element: u, setArray: l },
              Math.random()
            );
          }),
        }),
...
const Rd = () => we.jsx(Td, {}),
  Od = Ql.createRoot(document.getElementById("root"));
Od.render(we.jsx(Rd, {}));
